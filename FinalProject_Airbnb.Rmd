...
listings_details %>% 
  dplyr::select(price2, neighbourhood, property_type, room_type) %>%
...
rents.test <-
  ...
  mutate(Regression = "Baseline Regression",
         price2.Predict = predict(reg1, rents.test),
...
rmse.test <- caret::MAE(reg1_predict, rents.test$price2)
